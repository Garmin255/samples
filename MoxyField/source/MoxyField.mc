...
class MO2Field extends WatchUi.DataField {
    ...
    private const _fonts = [Graphics.FONT_XTINY, Graphics.FONT_TINY, Graphics.FONT_SMALL, Graphics.FONT_MEDIUM, Graphics.FONT_LARGE,
    ...
    public function onLayout(dc as Dc) as Void {
        ...
        if (hLayoutFontIdx > vLayoutFontIdx) {
            ...
            _separator = [(width / 2), top + BORDER_PAD, (width / 2), height - BORDER_PAD];
        } else {
