...
class BulkDownloadBehaviorDelegate extends WatchUi.BehaviorDelegate {
    ...
    public function onSelect() as Boolean {
        ...
        if (possibleConnection) {
            ...
            _view.setText(["Sync", "Complete"]);
        } else if (hasWiFiSupport && !hasLteSupport) {
            _view.setText(["WiFi", "Not", "Configured"]);
        } else if (!hasWiFiSupport && hasLteSupport) {
            _view.setText(["LTE", "Not", "Configured"]);
        } else {
            _view.setText(["WiFi/LTE", "Not", "Configured"]);
        }
    ...
    public function onMenu() as Boolean {
        ...
        _view.setText(["Reset", "Successful"]);
